...
interface MockSVGElement {
  ...
  setAttributeNS: jest.Mock;
  textContent: string;
}

interface MockDocument {
  createElementNS: jest.Mock<MockSVGElement, [string, string]>;
}
...
describe('SVG', () => {
  ...
  test('should create SVG element with correct namespace', () => {
    SVG(mockDocument as unknown as Document, 'rect');
  ...
  test('should create element with specified name', () => {
    SVG(mockDocument as unknown as Document, 'circle');
    expect(mockDocument.createElementNS).toHaveBeenCalledWith(
      'http://www.w3.org/2000/svg',
      'circle'
    );

    SVG(mockDocument as unknown as Document, 'path');
    expect(mockDocument.createElementNS).toHaveBeenCalledWith(
      'http://www.w3.org/2000/svg',
      'path'
    );
  ...
  test('should set regular attributes using setAttribute', () => {
    ...
    SVG(mockDocument as unknown as Document, 'rect', attributes);
  ...
  test('should handle xlink:href attribute specially using setAttributeNS', () => {
    ...
    SVG(mockDocument as unknown as Document, 'use', attributes);
  ...
  test('should set text content when provided', () => {
    ...
    SVG(mockDocument as unknown as Document, 'text', {}, text);
  ...
  test('should handle undefined attributes (default parameter)', () => {
    SVG(mockDocument as unknown as Document, 'ellipse');
  ...
  test('should return the created element', () => {
    const result = SVG(mockDocument as unknown as Document, 'polygon');
  ...
  test('should handle numeric attribute values as strings', () => {
    ...
    SVG(mockDocument as unknown as Document, 'circle', attributes, 'Test Text');
